 ...
 * @author Guillermo1
 */
public class FXMLProdutoCadastrarController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            Logger.getLogger(FXMLProdutoCadastrarController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
